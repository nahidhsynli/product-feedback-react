...
function App() {
  return (
    <>
      <Hero className="hero">
        <aside id="aside">
          <FeedbackBoard className="feedback-board">
            <h2>Frontend Mentor</h2>
            <p>Feedback Board</p>
          </FeedbackBoard>
          <FeedbackCategory className="feedback-category">
            <div className="aii bg-primary">
          ...
          <Roadmap className="roadmap p-2">
            <div className="roadmap-heading d-flex justify-content-between align-items-center p-3">
              <RoadmapHeadingH1>Roadmap</RoadmapHeadingH1>
              <RoadmapHeadingA href="/feedback-app/src/roadmap.html">
                View
              </RoadmapHeadingA>
            </div>
            <div className="roadmap-main p-2">
              <div className="roadmap-planned d-flex justify-content-between">
                <div className="roadmap-left d-flex gap-3">
                  <svg
                    className="mt-2"
              ...
              <div className="roadmap-inprogress d-flex justify-content-between">
                <div className="roadmap-left d-flex gap-3">
                  <svg
                    className="mt-2"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="roadmap-live d-flex justify-content-between">
                <div className="roadmap-left d-flex gap-3">
                  <svg
                    className="mt-2"
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className={styles.suggestion}>
          <div className={styles.suggestionHeader}>
            <div className={styles.suggestionHeaderLeft}>
              ...
              <h3 className="fs-3 mt-1">2 Suggestions</h3>
              <div className={styles.customSelect}>
                <label htmlFor="mySelect" className={styles.sortbyLabel}>
                  sort by:
                </label>
                <select id="mySelect" className={styles.customSelectSelect}>
                  <option className={styles.customSelectOption} value="option1">
                    Most Upvotes
                  </option>
                  <option className={styles.customSelectOption} value="option2">
                    Least Upvotes
                  </option>
                  <option className={styles.customSelectOption} value="option3">
                    Most Comments
                  </option>
                  <option className={styles.customSelectOption} value="option4">
                    Least Comments
                  </option>
                </select>
              </div>
          ...
          <div className={styles.feedbackBox}>
            <div className={styles.upvoteMiddle}>
